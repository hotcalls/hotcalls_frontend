...
import { User, Building, CreditCard, Check, Phone, Users, Plus, Trash2, Settings as SettingsIcon, ExternalLink } from "lucide-react";
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className={textStyles.cardSubtitle}>
                        {isLoadingSubscription ? "..." : currentPlan.price} pro Monat
                      </p>
                    </div>
